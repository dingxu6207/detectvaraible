...
data = pd.read_csv('AP18201061.csv', sep = ',' )
...
y = nphjmag[:,1]
ls = LombScargle(t, y)
frequency, power = ls.autopower(minimum_frequency=0.1, maximum_frequency=4.5)
...
S = pyPDM.Scanner(minVal=0.1, maxVal=4.5, dVal=0.0001, mode="frequency")
P = pyPDM.PyPDM(t, y)
